...
K_h = 75/100*17513.38 %horizontal spring stiffness (based on 100lbs/in, converted to N/m)
preload_Dist = 0/12*.3048; % preload on the vertical spring when x=0 (converting inches to m)
